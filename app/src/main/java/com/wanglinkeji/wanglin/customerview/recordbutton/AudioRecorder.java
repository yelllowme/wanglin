package com.wanglinkeji.wanglin.customerview.recordbutton;
...
public class AudioRecorder implements RecordStrategy {
	...
	private String fileFolder = Environment.getExternalStorageDirectory().getPath() + "/wanglin";
	...
	public void ready() {
		...
		//Log.d("yellow_temp", "ready()--->" + getFilePath());
	}
	...
	public void deleteOldFile() {
		...
		//Log.d("yellow_temp", "deleteOldFile()--->" + getFilePath());
	}
